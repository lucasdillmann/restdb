...
/**
 * [LogicalOperatorJdbcPredicate] implementation for SQL AND
 *
 * @author Lucas Dillmann
 * @since 1.0.0, 2020-03-29
 */
class AndLogicalOperatorJdbcPredicate(
    /**
     ...
     * SQL instructions
     */
    override val sqlInstructions = "${leftPredicate.sqlInstructions} AND ${rightPredicate.sqlInstructions}"
}