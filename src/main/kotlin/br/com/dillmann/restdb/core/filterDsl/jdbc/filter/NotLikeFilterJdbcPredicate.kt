...
/**
 * [FilterJdbcPredicate] implementation for SQL NOT LIKE instruction
 *
 * @author Lucas Dillmann
 * @since 1.0.0, 2020-03-29
 */
class NotLikeFilterJdbcPredicate(
    /**
     ...
     * SQL instructions
     */
    override val sqlInstructions = "$columnName NOT LIKE :$parameterId"
