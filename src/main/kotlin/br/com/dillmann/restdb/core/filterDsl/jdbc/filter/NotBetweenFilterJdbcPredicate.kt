...
/**
 * [FilterJdbcPredicate] implementation for SQL NOT BETWEEN instruction
 *
 * @author Lucas Dillmann
 * @since 1.0.0, 2020-03-29
 */
class NotBetweenFilterJdbcPredicate(
    /**
     ...
     * SQL instructions
     */
    override val sqlInstructions = "$columnName NOT BETWEEN :$leftParameterId AND :$rightParameterId"
