 ...
 */
class NotEqualsFilterJdbcPredicateUnitTests {

    private val value = randomString()
    private val columnName = randomString()
    private val predicate = NotEqualsFilterJdbcPredicate(columnName, value)

    @Test
    fun `output sql should use not equals instruction`() {
        // execution
