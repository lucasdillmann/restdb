 ...
 */
class LessThanFilterJdbcPredicateUnitTests {

    private val value = randomString()
    private val columnName = randomString()
    private val predicate = LessThanFilterJdbcPredicate(columnName, value)

    @Test
    fun `output sql should use less than instruction`() {
        // execution
