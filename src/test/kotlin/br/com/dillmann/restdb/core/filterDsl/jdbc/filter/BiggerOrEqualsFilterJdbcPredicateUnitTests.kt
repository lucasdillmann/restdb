 ...
 */
class BiggerOrEqualsFilterJdbcPredicateUnitTests {

    private val value = randomString()
    private val columnName = randomString()
    private val predicate = BiggerOrEqualsFilterJdbcPredicate(columnName, value)

    @Test
    fun `output sql should use bigger or equals instruction`() {
        // execution
