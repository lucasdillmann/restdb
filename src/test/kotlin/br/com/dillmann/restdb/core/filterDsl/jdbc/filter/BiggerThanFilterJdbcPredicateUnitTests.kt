 ...
 */
class BiggerThanFilterJdbcPredicateUnitTests {

    private val value = randomString()
    private val columnName = randomString()
    private val predicate = BiggerThanFilterJdbcPredicate(columnName, value)

    @Test
    fun `output sql should use bigger instruction`() {
        // execution
