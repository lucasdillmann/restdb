 ...
 */
class LessOrEqualsFilterJdbcPredicateUnitTests {

    private val value = randomString()
    private val columnName = randomString()
    private val predicate = LessOrEqualsFilterJdbcPredicate(columnName, value)

    @Test
    fun `output sql should use less or equals instruction`() {
        // execution
